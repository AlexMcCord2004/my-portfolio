    ...
    <section className="load-page flex flex-col gap-10 md:flex-row md:items-center">
      ...
      <div className="flex-1 space-y-6">
        ...
        <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
          Hi, I&apos;m <span className="text-red-500" >Alex McCord</span>.
          <br />
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="/projects"
            className="rounded-md border border-neutral-700 px-4 py-2 text-sm font-medium text-red-000 transition hover:border-red-500 hover:text-red-300"
          >
            View my projects
          </a>
          <a
          ...
          <div className=" flex flex-wrap gap-2 text-xs">
            {["TypeScript", "React", "Next.js", "Tailwind CSS", "Node.js", "Java", "Python" ,"Git / Github","C / C++" 
              ...
              (tech) => (
                <span
                  key={tech}
                  className="rounded-full border border-neutral-700 px-3 py-1 text-white"
                >
                  {tech}
                </span>
              )
      ...
      <div className="mt-6 flex-1 md:mt-1 flex flex-col gap-4">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="w-full rounded-xl border border-neutral-800 bg-neutral-900/60 p-4 text-sm text-neutral-300">
            <p className="font-medium text-red-500">Focused on Growth</p>
            ...
            <a
              href="/projects"
              className="mt-3 inline-block text-xs text-red-500 underline underline-offset-4 hover:text-red-400"
            >
              View my projects →
            </a>
          </div>
